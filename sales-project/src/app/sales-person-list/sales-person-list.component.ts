...
export class SalesPersonListComponent implements OnInit {
  ...
  salesPersonList : SalesPerson[] = [
    new SalesPerson ("Simplice","Chedjou","chedjou@yahoo.fr",40000),
    new SalesPerson ("Jean Pierre","Fossi","jeanpierre@yahoo.com",50000),
    new SalesPerson ("Christance","Nekame","neckChristanc@yahoo.fr",60000),
    new SalesPerson ("Samuel","Kenmogne","samuel@yahoo.com",80000),
    new SalesPerson ("Clotilde","Kengne","clotildeKengne@gmail.com",20000),
    new SalesPerson ("Florence","Kuissi","florenceKuissu@yahoo.fr",60000 )
  ];
